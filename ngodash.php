...
<body>
    ...
    <nav class="nav nav_top">
        ...
        <div class="nav_side">
            ...
            <a href="about_ngo.html">ABOUT US</a>
           <!-- <a href="ngo-list.php">DONATE</a> -->
            <a href="ngocontact.php">CONTACT</a>
        ...
        <div class="product_container">
            ...
            <div class="item">
                ...
                <div class="item_content">
                    <h3>food and water</h3><br>
                    <p>We supply needy NGO's with basic necessities like pure food and water</p>
                    <br><br><br>
                </div>
            </div>
            ...
            <div class="item">
                ...
                <div class="item_content">
                    ...
                    <p>Health being the foremost priority, we aim at giving every medical support</p>
                    <br><br>
                </div>
            </div>
            ...
            <div class="item">
                ...
                <div class="item_content">
                    <h3>Education</h3><br>
                    <p>We provide education facilities to children through NGO</p>
                    <br><br>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="pages"> 
            <a href="ngodash.html"><img class="aimg" src="images/logo.png" width="250"></a> 
        ...
        <div class="doc">
            <h3>Navigation</h3>
            <a href="ngodash.html">Home</a>
            <a href="about_ngo.html">About</a>
            <a href="contact_ngo.html">Contact</a>
            <a href="ngoprofile.html">YOUR PROFILE</a>
